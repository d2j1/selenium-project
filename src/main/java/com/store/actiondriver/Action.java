...
public class Action extends BaseClass implements ActionInterface {
	...
	public boolean switchToFrameByIndex(WebDriver driver, int index) {
	    boolean flag = false;
	    try {
	        // Update to use Duration for the timeout
	...
	@Override
	public boolean switchToFrameByXPath(WebDriver driver, String xPath) {
	    boolean flag = false;
	    try {
	        ...
	        if (flag) {
	            System.out.println("Frame with XPath \"" + xPath + "\" is selected");
	        } else {
	            System.out.println("Frame with XPath \"" + xPath + "\" is not selected");
	        }
	    }
	}

	@Override
	public boolean switchToFrameByWebElement(WebDriver driver, WebElement iframeElement) {
	    boolean flag = false;
	    try {
	        driver.switchTo().frame(iframeElement);
	        flag = true;
	        ...
	        if (flag) {
	            System.out.println("Frame with WebElement \"" + iframeElement + "\" is selected");
	        } else {
	            System.out.println("Frame with WebElement \"" + iframeElement + "\" is not selected");
	        }
	    }
	}
